...
class GmailMessages(Messages):
    authentication_error_message = (
        "If you're not using an app-specific password, grab one here: https://myaccount.google.com/apppasswords"
    )
    ...
    def __init__(self, connection, parser_policy, **kwargs):
        self.IMAP_ATTRIBUTE_LOOKUP = merge_two_dicts(self.IMAP_ATTRIBUTE_LOOKUP, self.GMAIL_IMAP_ATTRIBUTE_LOOKUP_DIFF)
